...
public class Chat extends MenuBar{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase.child(String.valueOf(SignIn.whoami.hashCode())).child(Inbox.whichone).addListenerForSingleValueEvent(new ValueEventListener() {
    ...
    private void showMessage (Message m, String text,ArrayList<String> sms){
        ...
        mDatabase.child(SignIn.whoami).child(String.valueOf(messages.size())).setValue(m);
